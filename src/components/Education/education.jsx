...
const Education = () =>{
    ...
    return(
        <div className={`w-full h-[90vh] border-t-2 border-[white] rounded-2xl mb-6 education`} >
            <h1 className="text-[40px] text-[#008bc6] font-semibold inline-block mt-8 border-b-2 ml-16 border-[#008bc6] drop-shadow-[4px_8px_3px_#c2ebfe]">Education</h1>
