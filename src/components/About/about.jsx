    ...
    return(
        <div className="w-[100%] h-[90vh] flex mb-6 rounded-b-2xl about">
            ...
            <div className="w-[60%] h-[90vh] flex justify-center items-start flex-col pl-[120px] pr-[20px] rightAbout">
                <h1 className="text-[40px] text-[#008bc6] border-b-[2px] border-[#008bc6] mb-4">About Me</h1>
                <p className="text-[20px] tracking-wider break-words para pb-1 indent-10 leading-10">I'm a dynamic front-end developer deeply immersed in the realms of technology, design, and art.
                With a keen eye for detail and a passion for web development, I've dedicated my career to sculpting immersive online spaces.
                My expertise lies in the seamless translation of design concepts into captivating and functional websites.
