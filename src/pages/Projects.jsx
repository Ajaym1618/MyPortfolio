...
//     images: [swift1, swift2, swift3, swift4, swift5, swift6, swift7],
...
const projectsData = [
  {
    id: 1,
    title: "Resume Builder - SwiftResume",
    description:
      "SwiftResume is a resume builder that helps you create professional resumes quickly and easily. Customize templates, add your details, and download your polished resume in minutes.",
    technologies: ["React", "Node.js", "Express Js", "MongoDB"],
    images: [swift1, swift2, swift3, swift4, swift5, swift6, swift7],
  ...
  {
    id: 2,
    title: "Job Listing Application - CareerCraze",
    description:
      "CareerCraze is a job listing platform that helps you find and apply for the best job opportunities effortlessly. Discover your next career move with advanced search tools and a user-friendly experience.",
    technologies: ["React", "Node.js", "Express Js", "MongoDB"],
    images: [
...
const Projects = () => {
  ...
  useEffect(() => {
    const intervals = projectsData.map((_, projectIndex) => {
      return setInterval(() => {
        setCurrentImageIndexes((prevIndexes) => {
          ...
          newIndexes[projectIndex] = nextIndex;
          return newIndexes;
        });

        const carousel = carouselRefs.current[projectIndex];
        const projectImages = projectsData[projectIndex].images;
        const newScrollLeft =
          (carousel.clientWidth * currentImageIndexes[projectIndex]) %
          carousel.scrollWidth;

        if (carousel) {
          carousel.scrollTo({ left: newScrollLeft, behavior: "smooth" });
        }
      }, 3000); // Adjust the speed here (e.g., 3000 ms)
    });
      ...
      <div className="w-full px-4 max-sm:px-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projectsData.map((project, index) => (
            ...
            >
              <div
                className="w-full h-48 relative max-lg:h-auto overflow-hidden"
