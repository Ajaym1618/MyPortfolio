  ...
  return (
    <>
      <div className="w-[100%] h-[12vh] px-20 flex justify-between items-center bg-white shadow-sm shadow-slate-400 sticky top-0 z-30 max-lg:px-10 max-sm:px-5 dark:bg-clr-dark">
        ...
        <div
          className={`w-[100%] h-auto hidden text-xl font-semibold text-[#0275a4] px-8 py-6 max-sm:flex flex-col gap-6 bg-white z-10 fixed top-[72px] shadow-lg shadow-gray-500 transition-all ease-linear duration-500 dark:bg-clr-dark ${
